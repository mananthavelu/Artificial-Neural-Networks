...
net1=feedforwardnet(400,'trainlm');
net2=feedforwardnet(400,'trainbr');
...
f1=figure;
subplot(3,2,1);
plot(x,y,'bx',x,noise_y,'c',xtest,cell2mat(a11),'r',xtest,cell2mat(a21),'g'); % plot the sine function and the output of the networks
title('1 epoch');
legend('target','noisy target','trainlm','trainbr');

subplot(3,2,3); 
plot(x,y,'bx',x,noise_y,'c',xtest,cell2mat(a12),'r',xtest,cell2mat(a22),'g');
title('15 epochs');
legend('target','noisy target','trainlm','trainbr');

subplot(3,2,5);
plot(x,y,'bx',x,noise_y,'c',xtest,cell2mat(a13),'r',xtest,cell2mat(a23),'g');
title('1000 epochs');
legend('target','noisy target','trainlm','trainbr');
